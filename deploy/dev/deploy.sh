...
# ===========================================
# Blue-Green Upstream Configuration (Dev)
# ===========================================
...
deploy() {
    ...
    log_info "=========================================="
    log_info "Blue-Green 무중단 배포 시작 (Dev)"
    log_info "=========================================="
    ...
    log_success "=========================================="
    log_success "배포 완료! Active: $target_env"
    log_success "=========================================="
}
...
rollback() {
    ...
    log_success "롤백 완료! Active: $target_env"
}
...
status() {
    ...
    echo ""
    log_info "=========================================="
    log_info "Blue-Green 배포 상태 (Dev)"
    log_info "=========================================="
    log_info "현재 Active: $current_env"
    echo ""
    log_info "Blue: $(docker ps --filter 'name=damoa-app-blue' --format '{{.Status}}' || echo 'Not running')"
    log_info "Green: $(docker ps --filter 'name=damoa-app-green' --format '{{.Status}}' || echo 'Not running')"
    log_info "=========================================="
}
