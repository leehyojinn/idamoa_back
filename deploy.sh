...
UPSTREAM_CONF="$SCRIPT_DIR/../nginx/config/upstream.conf"
NGINX_CONTAINER="nginx-core"
HEALTH_CHECK_URL_BLUE="http://localhost:8081/api/health"
HEALTH_CHECK_URL_GREEN="http://localhost:8082/api/health"
