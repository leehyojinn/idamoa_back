...
public class BoardFilterController {
    ...
    @Operation(
        ...
        description = """
            ...
            **필터 동작 방식:**
            ...
            - metadata.board_types 배열에 'GALLERY'가 포함된 카테고리만 반환
    ...
    @Operation(
        ...
        description = """
            게시판 타입(GALLERY/DOCUMENT)에 따른 필터 목록을 동적으로 조회합니다.
            ...
            **확장 가능성:**
            - 새로운 게시판 타입 추가 시 DB에 board_types만 설정하면 자동으로 필터 제공
            - 카테고리별로 어떤 게시판에서 사용할지 유연하게 관리 가능
            """
    )
    @GetMapping
