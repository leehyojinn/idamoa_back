...
@Table(name = "estimate_request_attachments", indexes = {
    @Index(name = "idx_estimate_request_attachments_request", columnList = "estimate_request_id"),
    @Index(name = "idx_estimate_request_attachments_file", columnList = "file_id"),
    @Index(name = "idx_estimate_request_attachments_order", columnList = "estimate_request_id, display_order")
})
public class EstimateRequestAttachment {
