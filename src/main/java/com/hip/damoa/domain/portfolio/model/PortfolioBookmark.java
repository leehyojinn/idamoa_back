...
@Table(name = "portfolio_bookmarks",
    ...
    indexes = {
        @Index(name = "idx_portfolio_bookmarks_portfolio_id", columnList = "portfolio_id"),
        @Index(name = "idx_portfolio_bookmarks_user_id", columnList = "user_id")
    }
)
public class PortfolioBookmark {
     ...
     * 정적 팩토리 메서드
     */
    public static PortfolioBookmark of(CompanyPortfolio portfolio, User user) {
