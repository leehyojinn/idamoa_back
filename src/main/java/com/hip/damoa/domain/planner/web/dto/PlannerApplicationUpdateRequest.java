...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "플래너 신청서 수정 요청")
public class PlannerApplicationUpdateRequest {
    ...
    @Schema(description = "신청 내용 (상세 설명)", example = "병원 인테리어 리모델링을 계획하고 있습니다.")
    ...
    // 신청자 정보
    @Schema(description = "신청자 성함", example = "김원장")
    ...
    // 희망 일정 (1~3개)
    @Schema(description = "희망 상담 일정 (1~3개, 우선순위별)")
